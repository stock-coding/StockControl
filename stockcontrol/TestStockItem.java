...
class TestResult
{
    ...
    /**
     * Constructs a new TestResult. This constructor also records how many tests
     * passed and failed using two static fields in the TestResult class.
     * 
     * @param name The name of the test that was run
     * @param passed Whether the test passed
     * @param message The message generated by the test
     */
